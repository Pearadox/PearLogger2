...
class Ui_optionsDialog(object):
    def setupUi(self, optionsDialog):
        ...
        optionsDialog.resize(431, 388)
        self.tabWidget = QtWidgets.QTabWidget(optionsDialog)
        self.tabWidget.setGeometry(QtCore.QRect(0, 0, 431, 321))
        ...
        self.time_length_limit_checkBox.setGeometry(QtCore.QRect(180, 10, 321, 31))
        font = QtGui.QFont()
        ...
        self.minimum_hours_label.setGeometry(QtCore.QRect(90, 50, 201, 31))
        font = QtGui.QFont()
        font.setFamily("OpenSymbol")
        ...
        self.minimum_hours_spinBox.setGeometry(QtCore.QRect(300, 50, 91, 31))
        ...
        self.maximum_hours_label.setGeometry(QtCore.QRect(100, 90, 191, 31))
        font = QtGui.QFont()
        font.setFamily("OpenSymbol")
        font.setPointSize(11)
        ...
        self.maximum_hours_spinBox.setGeometry(QtCore.QRect(300, 90, 91, 31))
        ...
        self.time_window_checkBox.setGeometry(QtCore.QRect(180, 140, 301, 31))
        font = QtGui.QFont()
        font.setFamily("OpenSymbol")
        font.setPointSize(15)
        ...
        self.window_open_label.setGeometry(QtCore.QRect(50, 180, 241, 31))
        font = QtGui.QFont()
        font.setFamily("OpenSymbol")
        font.setPointSize(11)
        ...
        self.window_close_label.setGeometry(QtCore.QRect(40, 220, 251, 31))
        font = QtGui.QFont()
        font.setFamily("OpenSymbol")
        font.setPointSize(11)
        ...
        self.window_open_timeEdit.setGeometry(QtCore.QRect(300, 180, 118, 31))
        ...
        self.window_close_timeEdit.setGeometry(QtCore.QRect(300, 220, 118, 31))
        ...
        self.weekday_radioButton.setGeometry(QtCore.QRect(10, 60, 191, 21))
        font = QtGui.QFont()
        font.setFamily("OpenSymbol")
        font.setPointSize(11)
        ...
        self.saturday_radioButton.setGeometry(QtCore.QRect(10, 110, 151, 21))
        font = QtGui.QFont()
        font.setFamily("OpenSymbol")
        font.setPointSize(11)
        ...
        self.sunday_radioButton.setGeometry(QtCore.QRect(10, 160, 131, 21))
        font = QtGui.QFont()
        font.setFamily("OpenSymbol")
        font.setPointSize(11)
        ...
        self.label.setGeometry(QtCore.QRect(30, 10, 291, 31))
        font = QtGui.QFont()
        font.setFamily("OpenSymbol")
        ...
        self.student_dawson_checkBox.setGeometry(QtCore.QRect(30, 50, 311, 21))
        font = QtGui.QFont()
        font.setFamily("OpenSymbol")
        font.setPointSize(11)
        ...
        self.student_pearland_checkBox.setGeometry(QtCore.QRect(30, 80, 281, 21))
        font = QtGui.QFont()
        font.setFamily("OpenSymbol")
        font.setPointSize(11)
        ...
        self.student_turner_checkBox.setGeometry(QtCore.QRect(30, 110, 241, 21))
        font = QtGui.QFont()
        font.setFamily("OpenSymbol")
        font.setPointSize(11)
        ...
        self.apply_button.setGeometry(QtCore.QRect(150, 350, 121, 23))
        self.apply_button.setObjectName("apply_button")
        self.line = QtWidgets.QFrame(optionsDialog)
        self.line.setGeometry(QtCore.QRect(20, 330, 391, 20))
