...
class Ui_optionsDialog(object):
    def setupUi(self, optionsDialog):
        ...
        self.maximun_hours_spinBox = QtWidgets.QDoubleSpinBox(self.log_rules_tab)
        self.maximun_hours_spinBox.setGeometry(QtCore.QRect(170, 140, 91, 31))
        self.maximun_hours_spinBox.setDecimals(1)
        self.maximun_hours_spinBox.setMaximum(999.0)
        self.maximun_hours_spinBox.setObjectName("maximun_hours_spinBox")
